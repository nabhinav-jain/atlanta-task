    ...
    <form class="px-6 py-6 grid grid-cols-1 md:grid-cols-2 gap-4" id="editUser" enctype="multipart/form-data" method="POST">
     <input type="hidden" name="userid" id="userid" >
      ...
      <div>
        ...
        <input type="tel" id="editmobileNo" name="editmobileNo" placeholder="Enter mobile no" maxlength="10" pattern="^\d{10}$" required class="mt-1 block w-full border border-gray-300 rounded-md px-3 py-2 text-sm focus:outline-none" oninput="this.value = this.value.replace(/\D/g, '').slice(0, 10);" />
